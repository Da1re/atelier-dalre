...
export const PROJECTS: Project[] = [
  {
    ...
    highlights: [
      ...
      {
        title:
          "에디터 패키지 — 요구사항 맞춤 설계 & Module Federation 독립 배포",
        description:
      ...
      },
      {
        ...
        description:
          "Drag & Drop 기반 메뉴 계층 구조 관리, 부서·직급별 메뉴 접근 권한 필터링(RBAC), IP 접근 제어 시스템 구현.",
      },
      {
        title: "통합검색 클라이언트",
        description:
      ...
      {
        title: "공통 PASS 본인인증 util",
        description:
          "PASS 본인인증·보호자인증 공통 Util 설계 및 구현. REST API 연동, 인증 결과 처리, 에러 핸들링, UI 상태 관리 포함한 완전한 인증 플로우 개발.",
      },
    ],
...
공통 디자인 시스템을 처음부터 설계하면서 "단순히 예쁜 컴포넌트"가 아닌, 비즈니스 로직을 캡슐화한 재사용 가능한 컴포넌트의 가치를 체감했습니다.`,
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        description:
          "채팅 세션 생성·조회·삭제 Server Action 연동. 사이드바 최근 대화 목록, 초기 대화 영역, 스크롤 UX 포함한 채팅 레이아웃 전체 구현. AI 응답 마크다운 파싱 및 렌더링 처리.",
      },
      {
        title: "다중 파일 첨부 & 다운로드",
        description:
          "파일 확장자 제한, 다중 첨부 업로드, 업로드 직후 다운로드 처리. reference JSON 파싱 및 출처 필드 연동.",
      },
      {
        title: "스크랩 관리",
        description:
  ...
  },
  {
    ...
    subtitle: "전역 아키텍처 설계 — 화상회의 SDK 핸들링",
    company: "(주)세이코어",
    period: "2025.02 ~ 현재",
    status: "in-progress",
    size: "large",
    ...
    highlights: [
      {
        title: "화상회의 SDK 통합 — MEET",
        description:
          "WebRTC 기반 MEET SDK를 monorepo 환경에 통합. 실시간 영상·음성 스트림 관리, 참가자 상태 동기화, 파일 공유 기능 구현. SDK 라이프사이클을 React 컴포넌트 생명주기와 연결하여 안정적인 연결 관리.",
      },
      {
        title: "전역 Auth Layer 설계",
        description:
          "Jotai 기반 전역 인증 상태 관리 아키텍처 설계. Access Token 자동 갱신(Silent Refresh), 인증 만료 감지 및 로그인 리다이렉트, Role 기반 route guard를 전역 레이어로 구현하여 각 페이지에서 인증 로직을 제거.",
      },
      {
        title: "전역 마스킹 해제 모달",
        description:
      ...
      {
        title: "교육청 직원(EDU_OFFICER) 전용 플로우 설계",
        description:
          "기존 시스템에 신규 사용자 타입을 추가하며 교육청 전용 레이아웃·헤더·라우팅 체계를 독립적으로 설계. 로그인, 단계별 회원가입, 아이디/비밀번호 찾기 전체 플로우 구현. userType 공통 유틸로 역할별 분기 처리를 중앙화.",
      },
      {
        title: "교육청 회의 일정 관리 시스템",
        description:
          "회의 일정 목록·상세·생성·수정 전체 개발. ConferenceCalendarBoard를 어댑터 패턴으로 분리하여 캘린더 컴포넌트와 비즈니스 로직을 독립적으로 유지. 참석자 조회 모달 및 역할별 동적 테이블 컬럼 구현.",
      },
      {
        title: "Google OTP 인증 플로우",
        description:
          "어드민 보안 강화를 위한 Google OTP 등록·인증 플로우 설계 및 구현. 외부 사용자 임시 토큰 검증 API 연동.",
      },
    ],
    ...
    highlights: [
      {
        title: "동적 위즈윅 신청서 로직",
        description:
          "단일 컴포넌트 17개, 그룹 컴포넌트 6개 기반의 동적 신청서 시스템 설계 및 개발. 신청서 임시 저장, 미리보기, 동적 프로세스 추가 로직 구현.",
      },
      {
    ...
    highlights: [
      {
        title: "핵심 기능 개발",
        description:
          "JWT 로그인/회원가입, 사용자별 알림 시스템, 배송 API, 통합검색, 메인 페이지, 플랫폼 설정/관리 페이지 개발.",
      },
    ],
    retrospective: undefined,
    coverColor: "color-mix(in srgb, var(--foreground) 4%, transparent)",
    ...
    highlights: [
      {
        title: "대시보드 & 설문조사",
        description:
          "메인 페이지, 설문조사 기능, 마음챙김 영상 매칭, 대시보드 인터페이스, 사용자 통계 개발.",
      },
    ],
    retrospective: undefined,
    coverColor: "color-mix(in srgb, var(--foreground) 4%, transparent)",
