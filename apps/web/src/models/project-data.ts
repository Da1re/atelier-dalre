...
export const PROJECTS: Project[] = [
  {
    ...
    highlights: [
      ...
      {
        title: "PASS 본인인증 / 보호자인증 연동",
        description:
          "회원 정보 수정 및 담당자 직권 회원가입에 PASS 본인인증·보호자인증 적용. 14세 미만/이상 분기 로직 및 단계별 유효성 검사 구현.",
      },
    ],
    ...
    highlights: [
      {
        ...
        description:
          "WebRTC 기반 MEET SDK를 monorepo 환경에 통합. 실시간 영상·음성 스트림 관리, 참가자 상태 동기화, 화면 공유 기능 구현. SDK 라이프사이클을 React 컴포넌트 생명주기와 연결하여 안정적인 연결 관리.",
      },
      {
